                ...
                <div>
                    ...
                    <div class="del-inf">
                        ...
                        <div class="delivery-options">
                            ...
                            <div>
                                <div class="opt">
                                    <input checked type="radio" class="radio-input" name="group-${id}" value="1" id="radio-${id}-1" onclick="handleRadioClicked(('${id}'),this)">
                                    <div>
                                ...
                                <div class="opt">
                                    <input type="radio" class="radio-input" name="group-${id}" value="2" id="radio-${id}-2" onclick="handleRadioClicked(('${id}'),this)">
                                    <div>
                                ...
                                <div class="opt">
                                    <input type="radio" class="radio-input" name="group-${id}" value="3" id="radio-${id}-3" onclick="handleRadioClicked(('${id}'),this)">
                                    <div>
